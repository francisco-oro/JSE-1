...
while(true){
    ...
    let choose = prompt("Input a command: /first: Displays the first contact, /last: Displays the last contact, /all: Displays all contacts, /new: Adds a new contact, /quit: Exits the program, /showContact: Displays the contact with the given index");
    if(choose == '/quit'){
        break;
    }
    switch(choose){
